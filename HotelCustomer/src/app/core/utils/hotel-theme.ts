...
export function heroImageUrl(storefront: PublicStorefront): string | null {
  const roomImage = storefront.rooms.find((r) => r.primaryImageUrl)?.primaryImageUrl;
  return roomImage ?? storefront.logoUrl;
}
